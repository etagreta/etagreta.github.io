...
- Dissemination corner in [The Reasoner](http://thereasoner.org/), _BRIO: From topology to a logic of uncertainty_, November 2023 ([here](\docs/TheReasoner-176.pdf))
...
- Seminario permanente, _Un numero finito di idee sulla definizione di infinito_, [ZEST!](https://www.facebook.com/ZEST.sapere.aude/), 2020 ([recording](https://www.youtube.com/watch?v=JAulXUkkTXQ))
...
Previously a postdoc with [LUCI Lab](https://luci.unimi.it/) at the University of Milan, on the [BRIO](https://sites.unimi.it/brio/) project, and a member of the Scientific Committee of the [ItaCa](https://progetto-itaca.github.io/) community. PhD from the [Mathematics Department at the University of Genova](https://www2.dima.unige.it/), under the supervision of [Pino Rosolini](https://www.dima.unige.it/~rosolini/) with the [logic group](http://logic.dima.unige.it/).
