...
I am a mathematician at the intersection of rigorous research and applied AI development, with specialised expertise in Data Science, Machine Learning, and Generative AI. I am driven by the challenge of turning complex research into practical, responsible solutions that create real social value. A natural communicator and educator, I am passionate about making AI understandable and empowering for everyone. I lead with curiosity, stay calm under pressure, and thrive in collaborative, interdisciplinary environments where connecting people and ideas makes the difference.
\end{minipage}\hfill
...
\textit{Co-founder, AI Research Scientist} \\
Co-founded a start-up with industry experts to help public and private organizations achieve regulatory compliance with transparency and fairness at its core. Led end-to-end R\&D across multiple projects, combining applied research with hands-on development to deliver concrete, production-ready solutions.
On the Generative AI front, designed and evaluated Retrieval-Augmented Generation (RAG) pipelines, focusing on retrieval quality, answer faithfulness, and end-to-end system performance -- translating research findings directly into architectural and implementation improvements. On the Machine Learning side, conducted in-depth assessments of classification algorithms, analysing performance, robustness, and fairness metrics to inform model selection and deployment decisions.
Throughout, acted as the bridge between research and engineering, ensuring that theoretical insights were systematically turned into tested, maintainable, and explainable solutions aligned with regulatory requirements.
...
Python, C, Git, SQL, tools for formal methods (SAT, SMT, Prolog, NuSMV).
...
\vfill
\hfill\small\textit{Last updated: March 2026}
