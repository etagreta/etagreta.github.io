...
\vspace{2mm}
	...
	\qquad
    \faIcon{map-marker-alt} Milan, Italy
\end{center}
...
\faIcon{angle-right}\, Presented at 22nd International Conference of the Italian Association for Artificial Intelligence (AI*IA 2023) and published in the Proceedings of the 2nd Workshop on Bias, Ethical AI, Explainability and the role of Logic and Logic Programming.
...
\faIcon{angle-right}\, Accepted for TYPES 2023 (Jun 2023) and 108th PSSL (Sep 2023), presented in an invited talk at the LAMA Group at Université Savoie Mont Blanc (Nov 2023), accepted for publication.
...
\faIcon{angle-right}\, Presented at an invited talk at HoTTEST (Mar 2024) and CATNIP (May 2024), in preparation.
...
\faIcon{angle-right}\, Presented at invited talks at HoTT/UF (Apr 2023), accepted for a talk at ItaCa Fest (May 2022), submitted for publication.
...
\faIcon{angle-right}\, Accepted talk at Logic and higher structures at CIRM (Feb 2022) and TACL (Jun 2022), presented at an invited talk for the Compositional Systems and Methods group at TalTech.

\faIcon{angle-double-right} In publication.
